...
export default function AreaModelTrainer() {
  ...
  return (
    <div className="am-root">
      <style>{`
        .am-root { min-height:100vh; background:#f6f7fb; color:#20242d; font-family:Inter,ui-sans-serif,system-ui,sans-serif; display:grid; grid-template-rows:auto 1fr; }
        .am-top { display:flex; align-items:center; justify-content:space-between; gap:12px; flex-wrap:wrap; padding:14px 22px; border-bottom:2px solid #d9dfec; background:rgba(246,247,251,0.94); }
        .am-title { margin:0; font-size:1.1rem; font-weight:900; letter-spacing:0.02em; }
        .am-actions { display:flex; gap:10px; flex-wrap:wrap; }
        .am-btn, .am-home { min-height:44px; border:2px solid #d9dfec; border-radius:8px; background:#fff; color:#20242d; padding:9px 14px; font-size:0.9rem; font-weight:900; cursor:pointer; text-decoration:none; display:inline-flex; align-items:center; justify-content:center; }
        .am-btn:hover, .am-home:hover { border-color:#f97316; }
        .am-btn.primary { border-color:#f97316; background:#f97316; color:#fff; }

        .am-main { display:grid; grid-template-columns:minmax(300px, 380px) minmax(0, 1fr); gap:18px; padding:18px; align-items:start; }
        .am-panel { border:2px solid #d9dfec; border-radius:10px; background:#fff; padding:18px; box-shadow:0 12px 26px rgba(32,36,45,0.08); }
        .am-problem { display:grid; gap:8px; justify-items:start; margin-bottom:16px; }
        .am-label { margin:0; color:#657184; font-size:0.78rem; font-weight:900; letter-spacing:0.1em; text-transform:uppercase; }
        .am-problem-value { margin:0; color:#111827; font-size:clamp(2.2rem,6vw,3.6rem); line-height:1; font-weight:950; }
        .am-copy { margin:0; color:#657184; font-size:0.95rem; font-weight:700; line-height:1.45; }
        ...
        .am-plus { color:#657184; font-size:1.35rem; font-weight:900; }
        .am-input { width:100%; min-width:0; border:2px solid #d9dfec; border-radius:8px; padding:12px 10px; color:#111827; font-size:1.15rem; font-weight:900; text-align:center; }
        .am-input:focus, .am-box-input:focus { border-color:#f97316; outline:3px solid rgba(249,115,22,0.18); }
        .am-input.issue, .am-box.issue .am-box-input { border-color:#dc2626; outline:3px solid rgba(220,38,38,0.14); }
        .am-feedback { border:2px solid #d9dfec; border-radius:10px; background:#f9fafb; padding:12px 14px; color:#334155; font-size:0.96rem; font-weight:800; line-height:1.4; }
        .am-feedback.check { border-color:#f59e0b; background:#fff7ed; color:#9a3412; }
        .am-feedback.success { border-color:#22c55e; background:#ecfdf3; color:#166534; }

        .am-stage { display:grid; gap:14px; min-width:0; }
        .am-model { display:grid; gap:6px; min-height:468px; border:2px solid #cbd5e1; border-radius:10px; background:#e9edf5; padding:8px; }
        .am-corner, .am-axis, .am-side-axis { display:grid; place-items:center; border:2px solid #cbd5e1; border-radius:8px; background:#fff; color:#334155; font-weight:950; text-align:center; }
        .am-corner { color:#64748b; font-size:0.9rem; }
        ...
        .am-box { display:grid; align-content:center; justify-items:center; gap:10px; min-width:0; min-height:0; border:3px solid #475569; border-radius:10px; background:#fff8eb; padding:12px; transition:border-color 140ms ease, background 140ms ease; }
        .am-box:nth-child(6), .am-box:nth-child(8) { background:#edfdf9; }
        .am-box.correct { border-color:#22c55e; background:#ecfdf3; }
        .am-box.issue { border-color:#dc2626; background:#fff1f2; }
        .am-mul-label { color:#64748b; font-size:0.9rem; font-weight:900; text-align:center; }
        .am-box-input { width:min(150px, 100%); border:2px solid #d9dfec; border-radius:8px; background:#fff; padding:10px 8px; color:#111827; font-size:1.45rem; font-weight:950; text-align:center; }
        .am-process { display:grid; gap:10px; border:2px solid #d9dfec; border-radius:10px; background:#fff; padding:14px; }
        .am-process-title { margin:0; color:#64748b; font-size:0.78rem; font-weight:950; letter-spacing:0.1em; text-transform:uppercase; }
        .am-process-lines { display:grid; grid-template-columns:repeat(2,minmax(0,1fr)); gap:8px; }
        .am-step { border:1px solid #e2e8f0; border-radius:8px; background:#f8fafc; padding:10px; color:#1f2937; font-weight:900; text-align:center; }
        .am-total-row { display:grid; grid-template-columns:1fr auto; gap:10px; align-items:center; }
        .am-total-text { color:#334155; font-size:1rem; font-weight:900; }
